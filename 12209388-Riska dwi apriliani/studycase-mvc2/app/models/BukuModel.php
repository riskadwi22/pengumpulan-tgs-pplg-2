...
class BukuModel{
    ...
    public function tambahBuku($data)
    {
        ...
        $query = "INSERT INTO tb_pinjam (nama_peminjam, jenis_barang, no_barang, tgl_pinjam, tgl_kembali, status) VALUES (:nama_peminjam, :jenis_barang, :no_barang, :tgl_pinjam, :tgl_kembali, :status)";
        $this->db->query($query);
    ...
    public function updateDataBuku($data)
    {
        ...
        $query = "UPDATE tb_pinjam SET nama_peminjam=:nama_peminjam, jenis_barang=:jenis_barang, no_barang=:no_barang, tgl_pinjam=:tgl_pinjam, tgl_kembali=:tgl_kembali, status=:status WHERE id=:id";
        $this->db->query($query);
