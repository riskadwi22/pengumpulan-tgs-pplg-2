        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    {{-- Auth::check cek apakan sudah ada data login untuk memunculkan navbar --}}
                    @if (Auth::check())
                        <li class="nav-item">
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('medicine.create') }}">Tambah Data</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ route('medicine.data.stock') }}">Stok Obat</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        @if (Auth::user()->role == 'admin')
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{route('admin.order.data')}}">Data Pembelian</a>
                        </li>
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('user.data') }}">Kelola
                                    Akun</a>
                            </li>
                        @endif
                        <li class="nav-item">
